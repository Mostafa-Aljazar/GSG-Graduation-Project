...
export type UserOtpWhereInput = {
  ...
  otp?: Prisma.StringFilter<"UserOtp"> | string
...
export type UserOtpScalarWhereWithAggregatesInput = {
  ...
  otp?: Prisma.StringWithAggregatesFilter<"UserOtp"> | string
...
export type UserOtpOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "otp" | "expiresAt" | "createdAt", ExtArgs["result"]["userOtp"]>
...
export interface UserOtpDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  /**
   * Find zero or more UserOtps that matches the filter.
   * @param {UserOtpFindRawArgs} args - Select which filters you would like to apply.
   * @example
   * const userOtp = await prisma.userOtp.findRaw({
   *   filter: { age: { $gt: 25 } }
   * })
   */
  findRaw(args?: Prisma.UserOtpFindRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>

  /**
   * Perform aggregation operations on a UserOtp.
   * @param {UserOtpAggregateRawArgs} args - Select which aggregations you would like to apply.
   * @example
   * const userOtp = await prisma.userOtp.aggregateRaw({
   *   pipeline: [
   ...
   * })
   */
  aggregateRaw(args?: Prisma.UserOtpAggregateRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>
...
export interface UserOtpFieldRefs {
  ...
  readonly otp: Prisma.FieldRef<"UserOtp", 'String'>
 ...
 * UserOtp findRaw
 */
export type UserOtpFindRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
...
/**
 * UserOtp aggregateRaw
 */
export type UserOtpAggregateRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
